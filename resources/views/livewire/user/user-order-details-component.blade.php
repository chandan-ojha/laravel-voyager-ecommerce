                            ...
                            <ul class="products-cart">
                                ...
                                <li class="pr-cart-item">
                                    <div class="product-image">
                                        <figure><img src="{{ Voyager::image($item->product->image) }}" alt="{{$item->product->name}}"></figure>
                                    </div>
                                    <div class="product-name">
                                        <a class="link-to-product" href="{{route('product.productdetatilscomponent',['slug'=>$item->product->slug])}}">{{$item->product->name}}</a>
                                    </div>
