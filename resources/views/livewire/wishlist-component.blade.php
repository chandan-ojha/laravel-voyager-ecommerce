                ...
                <li class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ">
                    <div class="product product-style-3 equal-elem ">
                        <div class="product-thumnail">
                            <a href="{{route('product.productdetatilscomponent',['slug'=>$item->model->slug])}}" title="{{$item->model->name}}">
                                <figure><img src="{{ Voyager::image( $item->model->image) }}" alt="{{$item->model->name}}"></figure>
                            </a>
                        </div>
                        <div class="product-info">
                            <a href="{{route('product.productdetatilscomponent',['slug'=>$item->model->slug])}}" class="product-name"><span>{{$item->model->name}}</span></a>
